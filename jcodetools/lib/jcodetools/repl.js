 ...
 *
 * ***** END LICENSE BLOCK ***** */
// cp repl.js to /Users/bartuer/Library/Application\ Support/Firefox/Profiles/pwqi0wb0.default/extensions/mozrepl@hyperstruct.net/components/MozRepl.js
...
function init(context) {
    ...
    this._workContext     = context.content;
    this._creationContext[this._name] = this;
    this._workContext[this._name] = this;
