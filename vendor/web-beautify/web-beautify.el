...
(defvar web-beautify-html-program "~/etc/el/vendor/node_modules/js-beautify/js/bin/html-beautify.js"
  "The executable to use for formatting HTML.")

(defvar web-beautify-css-program "~/etc/el/vendor/node_modules/js-beautify/js/bin/css-beautify.js"
  "The executable to use for formatting CSS.")

(defvar web-beautify-js-program "~/etc/el/vendor/node_modules/js-beautify/js/bin/js-beautify.js"
