...
(defun lintnode-start ()
  ...
  (interactive)
  (start-process "lintnode-server" "*lintnode*" "node" (concat (file-name-directory "~/etc/el/vendor/node_modules/lintnode") "app.js")
                 ))

(defun flymake-jslint-init ()
  "Register lintnode to flymake."
