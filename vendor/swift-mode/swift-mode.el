...
;; Copyright (C) 2014, 2015 Chris Barrett, Bozhidar Batsov, Arthur Evstifeev
...
(defcustom swift-indent-switch-case-offset 4
...
(defvar swift-mode-map
  (let ((map (make-sparse-keymap)))
    (define-key map (kbd "C-c C-s") 'swift-mode-run-repl)
    (define-key map (kbd "C-c C-b") 'swift-mode-send-buffer)
