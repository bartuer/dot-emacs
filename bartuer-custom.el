...
")
 ...
 '(org-agenda-columns-add-appointments-to-effort-sum t) '(org-agenda-files (quote ("~/local/src/milestone/milestone.org" "~/local/src/itone/itone.org" "~/local/src/tone/tone.org" "~/local/src/pusher/pusher.org" "~/local/src/busy/busy.org" "~/local/src/bew/bew.org" "~/local/src/xrb/xrb.org" "~/local/src/yogi/yogi.org" "~/local/src/cells/cells.txt" "~/local/src/re2c_hw_bench/css.org" "~/local/src/bartuer.github.com/progress_bar.org" "~/org/quote.org" "~/org/diary.org" "~/org/note.org_archive" "~/org/note.org" "~/local/src/ccdv/ccdv.org" "~/local/src/widget/sense/audio.org" "~/local/src/realtime/realtime.org" "~/local/src/widget/card/application.org" "~/local/src/widget/card/image.org" "~/local/src/frototype/frototype.org" "~/local/src/widget/sense/sense.org" "~/local/src/widget/card/card.org" "~/local/src/buddy/plan.org" "~/local/src/deal/deal.org" "~/org/demo.org" "~/local/src/uki-imageCutter/imagecutter.org" "~/local/src/uki-imageCutter/file_input_in_runtime.org" "~/local/src/pass/pass.org" "~/local/src/bla/zaphinx.org" "~/local/src/pullee/pullee.org" "~/local/src/morus/morus.org" "~/org/next.org" "~/local/src/baza/sbs.org" "~/local/src/widget/collectionview/collectionview.org")))
