...
")
 ...
 '(org-agenda-files (quote ("~/local/src/bew/bew.org" "~/local/src/yogi/yogi.org" "~/local/src/cells/cells.txt" "~/org/quote.org" "~/org/diary.org" "~/org/note.org_archive" "~/org/note.org" "~/org/demo.org" "~/local/src/bla/zaphinx.org" "~/local/src/pullee/pullee.org" "~/local/src/morus/morus.org" "~/org/next.org" "~/local/src/baza/sbs.org" "~/local/src/widget/collectionview/collectionview.org")))
