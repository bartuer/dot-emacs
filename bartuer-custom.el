...
(custom-set-variables
 ...
 '(ibuffer-saved-filter-groups (quote (("normal" ("irc" (or (mode . rcirc-mode))) ("console" (or (mode . debugger-mode) (mode . inferior-ess-mode) (mode . inf-ruby-mode) (mode . shell-mode))) ("tags" (mode . tags-table-mode)) ("emacs" (or (mode . Custom-mode) (mode . lisp-interaction-mode) (mode . emacs-lisp-mode))) ("result" (or (mode . ediff-meta-mode) (mode . ediff-mode) (mode . occur-mode) (mode . compilation-mode) (name . "^\\*pP") (mode . grep-mode) (mode . completion-list-mode) (mode . apropos-mode) (saved . #("temp" 0 1 (auto-composed t) 1 2 (auto-composed t) 2 3 (auto-composed t) 3 4 (auto-composed t))))) ("org" (or (name . "^\\*Org") (mode . calendar-mode) (mode . org-mode))) ("dir" (saved . #("dir" 0 1 (auto-composed t) 1 2 (auto-composed t) 2 3 (auto-composed t)))) ("help" (saved . #("help" 0 1 (auto-composed t) 1 2 (auto-composed t) 2 3 (auto-composed t) 3 4 (auto-composed t)))) ("ver" (or (mode . vc-annotate-mode) (name . "^\\*VC") (mode . vc-mode) (name . "^\\*magit")))) ("version" ("lisp" (used-mode . emacs-lisp-mode)) ("page" (used-mode . Man-mode)) ("dir" (used-mode . dired-mode)) ("shell" (mode . shell-mode))) ("urls" ("urls" (name . "urls"))))))
 '(ibuffer-saved-filters (quote (("irc" (or (mode . rcirc-mode))) ("console" ((or (mode . debugger-mode) (mode . inferior-ess-mode) (mode . inf-ruby-mode) (mode . shell-mode)))) ("tags" ((mode . tags-table-mode))) ("emacs" (or (mode . Custom-mode) (mode . lisp-interaction-mode) (mode . emacs-lisp-mode))) ("result" (or (mode . ediff-meta-mode) (mode . ediff-mode) (mode . occur-mode) (mode . compilation-mode) (name . "^\\*pP") (mode . grep-mode) (mode . completion-list-mode) (mode . apropos-mode) (saved . #("temp" 0 1 (auto-composed t) 1 2 (auto-composed t) 2 3 (auto-composed t) 3 4 (auto-composed t))))) ("temp" ((name . "^\\*") (mode . fundamental-mode))) ("org" ((or (name . "^\\*Org") (mode . calendar-mode) (mode . org-mode)))) ("ver" ((or (mode . vc-annotate-mode) (name . "^\\*VC") (mode . vc-mode) (name . "^\\*magit")))) ("help" ((or (name . "^readme") (name . "^ri") (mode . help-mode) (mode . Info-mode) (mode . Man-mode)))) ("dir" ((mode . dired-mode))))))
