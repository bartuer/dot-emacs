...
(custom-set-variables
 ...
 '(grep-find-command "find . -type f  |grep -vE \"BROWSE|TAGS|.svn|drw|Binary|.bzr|.git|svn-base|z.js|z_min.js|*.pyc\" |sed -e 's+ +\\\\\\\\ +g'|xargs grep -niHE ")
