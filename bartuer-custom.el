...
")
 ...
 '(org-agenda-files (quote ("~/local/src/baza/sbs.org" "~/org/next.org" "~/org/next.org_archive" "~/local/src/busy/busy.org" "~/local/src/morus/morus.org" "~/local/src/pullee/pullee.org" "~/local/src/bla/zaphinx.org" "~/local/src/pass/pass.org" "~/local/src/3wk/3wk.org" "~/local/src/uki-imageCutter")))
