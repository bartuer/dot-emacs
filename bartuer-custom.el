...
")
 ...
 '(org-agenda-files (quote ("~/local/src/baza/sbs.org" "~/org/next.org" "~/local/src/morus/morus.org" "~/local/src/pullee/pullee.org" "~/local/src/bla/zaphinx.org" "~/local/src/pass/pass.org" "~/local/src/uki-imageCutter/file_input_in_runtime.org" "~/local/src/uki-imageCutter/imagecutter.org" "~/org/demo.org" "~/local/src/deal/deal.org" "~/local/src/buddy/plan.org" "~/local/src/widget/card/card.org" "~/local/src/widget/sense/sense.org" "~/local/src/frototype/frototype.org" "~/local/src/widget/card/image.org" "~/local/src/widget/card/application.org" "~/local/src/realtime/realtime.org" "~/local/src/widget/sense/audio.org" "~/local/src/ccdv/ccdv.org" "~/org/note.org" "~/org/note.org_archive" "~/org/diary.org" "~/org/quote.org")))
