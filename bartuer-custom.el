...
(custom-set-variables
 ...
 '(grep-find-command "find . -type f  |grep -vE \"BROWSE|TAGS|.svn|drw|Binary|.bzr|svn-base|z.js|z_min.js|*.pyc\" |sed -e 's+ +\\\\\\\\ +g'|xargs grep -niHE ")
...
")
 ...
 '(load-path (quote ("~/etc/el" "~/etc/el/auto-install" "~/etc/el/ess" "~/etc/el/icicles" "~/etc/el/org" "~/etc/el/vendor/cheat" "~/etc/el/vendor/gist" "~/etc/el/vendor/magit" "~/etc/el/vendor/rcodetools" "~/etc/el/vendor/rhtml" "~/etc/el/vendor/rinari/" "~/etc/el/vendor/rinari/jump" "~/etc/el/vendor/rinari/util" "~/etc/el/vendor/rinari/util/" "~/etc/el/vendor/rinari/util/jump/" "~/etc/el/vendor/textile-minor-mode/" "~/etc/el/vendor/yasnippet" "~etc/el/vendor/yaml-mode/trunk" "~/local/share/emacs/23.1/leim" "~/local/share/emacs/23.1/lisp" "~/local/share/emacs/23.1/lisp/calc" "~/local/share/emacs/23.1/lisp/calendar" "~/local/share/emacs/23.1/lisp/emacs-lisp" "~/local/share/emacs/23.1/lisp/emulation" "~/local/share/emacs/23.1/lisp/erc" "~/local/share/emacs/23.1/lisp/eshell" "~/local/share/emacs/23.1/lisp/gnus" "~/local/share/emacs/23.1/lisp/international" "~/local/share/emacs/23.1/lisp/language" "~/local/share/emacs/23.1/lisp/mail" "~/local/share/emacs/23.1/lisp/mh-e" "~/local/share/emacs/23.1/lisp/net" "~/local/share/emacs/23.1/lisp/nxml" "~/local/share/emacs/23.1/lisp/nxml/char-name" "~/local/share/emacs/23.1/lisp/nxml/char-name/unicode" "~/local/share/emacs/23.1/lisp/obsolete" "~/local/share/emacs/23.1/lisp/org" "~/local/share/emacs/23.1/lisp/play" "~/local/share/emacs/23.1/lisp/progmodes" "~/local/share/emacs/23.1/lisp/textmodes" "~/local/share/emacs/23.1/lisp/toolbar" "~/local/share/emacs/23.1/lisp/url" "~/local/share/emacs/23.1/site-lisp" "~/local/share/emacs/23.1/site-lisp/emms" "~/local/share/emacs/site-lisp")) t)
 ...
 '(org-agenda-files (quote ("~/local/src/baza/sbs.org" "~/org/next.org" "~/org/next.org_archive" "~/local/src/busy/plan.org")))
 ...
 '(org-refile-targets (quote (("~/local/src/baza/sbs.org" :tag . "research") ("~/local/src/baza/sbs.org" :tag . "design") ("~/local/src/baza/sbs.org" :tag . "checklist") ("~/local/src/baza/sbs.org" :tag . "bug") ("~/local/src/baza/sbs.org" :tag . "feature") ("~/local/src/baza/sbs.org" :tag . "tool") ("~/local/src/baza/sbs.org" :tag . "lib") ("~/local/src/baza/sbs.org" :tag . "deployment"))))
